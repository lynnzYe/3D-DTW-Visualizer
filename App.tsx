  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center h-screen bg-slate-900 text-white">
        <div className="text-xl animate-pulse font-light">
    ...
    <div className="relative w-screen h-screen flex overflow-hidden bg-slate-950">
      ...
      <div className="flex-1 relative">
        ...
        <div className="absolute bottom-6 left-6 text-white/40 text-xs font-medium space-y-1">
          ...
          <p>
            Pan: Cmd + Left Click + Drag / Right Click + Drag /{" "}
            <kbd className="bg-slate-800 px-1 rounded text-white/80 font-mono">
              WASD
            </kbd>
          </p>
          <p>
